...
async function exportAsDocx(title: string, html: string) {
  ...
  // Minimal DOCX: render paragraphs from plain-text lines
...
export default function DocEditorPage() {
  ...
  // ── Populate editor when doc loads ────────────────────────────────────────
  useEffect(() => {
    ...
    <div className={styles.shell}>
      ...
      <div className={styles.topbar}>
        ...
        <div className={styles.topbarActions}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            {showExportMenu && (
              <div className={styles.exportMenu}>
                <button className={styles.exportMenuItem} onClick={() => handleExport('docx')}>
                  Microsoft Word (.docx)
                </button>
                <button className={styles.exportMenuItem} onClick={() => handleExport('pdf')}>
                  PDF (.pdf)
                </button>
                <button className={styles.exportMenuItem} onClick={() => handleExport('html')}>
                  Web page (.html)
                </button>
                <button className={styles.exportMenuItem} onClick={() => handleExport('txt')}>
                  Plain text (.txt)
                </button>
              </div>
            )}
          ...
          {/* Outline toggle */}
          <button
            className={`${styles.exportBtn} ${showOutline ? '' : ''}`}
